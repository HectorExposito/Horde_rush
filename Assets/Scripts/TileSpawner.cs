...
public class TileSpawner : MonoBehaviour
{
    ...
    public GameObject prefab_sand2;
    public GameObject prefab_rocks;
    ...
    private void Update()
    {
        if(player.transform.position.x % map_width==0 || player.transform.position.y % map_height == 0)
        {
            CreateTileGroups();
            GenerateMap();
        }
    ...
    void CreateTileset()
    {
        ...
        tileset.Add(0, prefab_sand);
        tileset.Add(1, prefab_sand2);
        tileset.Add(2, prefab_rocks);
    }
